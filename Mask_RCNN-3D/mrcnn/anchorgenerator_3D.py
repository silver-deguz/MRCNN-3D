...
def generate_anchors(scales, ratios, shape, feature_stride, anchor_stride):
    ...
    ratios: 1D array of anchor ratios of width/height (same for depth/height).
            Example: [0.5, 1, 2]
...
def generate_pyramid_anchors(scales, ratios, feature_shapes, feature_strides,
    ...
    Returns:
    anchors: [N, (z1, y1, x1, z2, y2, x2)]. All generated anchors in one array.
        Sorted with the same order of the given scales. So, anchors of scale[0]
        come first, then anchors of scale[1], and so on.
    """
    # Anchors
