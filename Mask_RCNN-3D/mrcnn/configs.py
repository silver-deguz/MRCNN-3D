...
class configs(DefaultConfigs):
    ...
    def __init__(self, root_dir):
        ...
        self.pre_crop_size = self.pre_crop_size_2D
        ...
        ###########################
        # Matterport Data Configs #
        ###########################
        self.image_min_dim = 320
        ...
        self.num_epochs = 10
        self.num_train_batches = 20 if self.dim == 2 else 20
        self.batch_size = 2 if self.dim == 2 else 8
