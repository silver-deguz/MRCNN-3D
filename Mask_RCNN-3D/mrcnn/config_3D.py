...
class Config3D(object):
    ...
    # Dimension of image data. Default is 3 for 3D data.
    DIM = 3
    ...
    USE_MINI_MASK = True
    MINI_MASK_SHAPE = (56, 56, 56)  # (depth, height, width) of the mini-mask
    ...
    # GG 3D added for the 3D version
